...
*
*********************************************************************/
extern uint16_t g_Ver_RrdCfgFile_U16;
extern uint16_t g_Ver_SysPrmFile_U16;
extern uint16_t g_Ver_TMSIEC_U16;
extern uint16_t g_Ver_TMSRTS_U16;
extern uint16_t g_Ver_MAX1_U16;
...
*
*History:
*REV1.0.0     deng    2018/8/31  Create
*
*********************************************************************/
void VersionSet(modbus_mapping_t *mb_mapping,VERSION *Versi_p) 
{
    ...
    mb_mapping->tab_input_registers[211]=Versi_p -> SftCfgFile_Ver_U16;/*eclr.out Version of MCU1*/
    ...
    mb_mapping->tab_input_registers[222]=12 ;/*  MAX2_Ver_U16 MVB_Confm file Version*/
...
{
    Versi_p -> Total_Ver_U16  = 100; /*Total Version*/

    Versi_p -> Linux_Ver_U16 =  440;/*OS Version of MCU1*/
    Versi_p -> SySCfgFile_Ver_U16 = 100;/*eclr.out Version of MCU1*/
    Versi_p -> SftCfgFile_Ver_U16 = 100;/*boot Version of MCU1*/
    Versi_p -> EADS_RunVer_U16 = EADS_VERSION;/*Software configure file Version of MCU1*/
    Versi_p -> Boot_Ver_U16 = 200;/*Falut log set of MCU1*/

    Versi_p -> FPGA_Ver_U16 = 300;/*OS Version of MCU2*/
    Versi_p -> Urmdik_Ver_U16 = 400;/*OMAP_NEXT Version of MCU2*/
    Versi_p -> DevicTree_Ver_U16 = 500;/*boot Version of MCU2*/
...
/**********************************************************************
*Name           :   void TotalVerSet(uint32_t ver)
*Function       :   set Total Version 
*Para           :   
*
*Return         :   
*Version        :   REV1.0.0       
...
*
*********************************************************************/
void TotalVerSet(uint32_t ver,modbus_mapping_t *mb_mapping)
{
    mb_mapping->tab_input_registers[226]=ver;/*Total Version*/
}
void OS1VerSet(uint32_t ver,modbus_mapping_t *mb_mapping)
{
    mb_mapping->tab_input_registers[210]=ver;/*OS Version of MCU1*/
}
