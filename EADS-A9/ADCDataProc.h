...
#define VOL_BINTAN_FACTOR  24.0478 /*8bit = 24.047uV */

//20190821 is 10
//20190823 change to 100
#define CURR_REALTAN_FACTOR  10 /*VI = 0.1 * I */
#define VOL_REALTAN_FACTOR  550/*Vp = V /550 mV */
...
*
*********************************************************************/
int8_t ADC7913VIDataTran(uint32_t *BramInBuf,ADC_VI_VALUE *OutBuf,uint16_t TranLeng);
int8_t ADC7913VDataTran(uint32_t *BramInBuf,ADC_V_VALUE *OutBuf,uint16_t TranLeng);
int8_t ADC7913VIDataTranInt(uint32_t *BramInBuf,CHAN_DATA *OutBuf,uint16_t TranLeng,uint8_t TranType);
